...
Приложение с авторизацией и поиском товаров. Реализовано сохранение постоянной и временной сессии с refreh token. На странице товаров доступен поиск, обновление, сортировка (отдельным выпадающим списком и по нажатию на название столбца в шапке таблицы), изменение ширины столбцов таблицы, добавление товара, изменение отдельных полей товара в списке, постраничный вывод, выбор элементов. Выполнено в соответсвии с ТЗ. API работает с VPN.
